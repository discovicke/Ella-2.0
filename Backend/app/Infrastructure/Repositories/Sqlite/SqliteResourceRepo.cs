...
public class SqliteResourceRepo(IDbConnectionFactory connectionFactory) : IResourceRepository
{
    // Categories
    ...
    public async Task<long> CreateCategoryAsync(ResourceCategory category)
    {
        ...
        return await conn.ExecuteScalarAsync<long>(
            "INSERT INTO resource_categories (name) VALUES (@Name); SELECT last_insert_rowid();", category);
    }
    ...
    public async Task<long> CreateResourceAsync(BookableResource resource)
    {
        ...
        return await conn.ExecuteScalarAsync<long>(@"
            ...
            SELECT last_insert_rowid();", resource);
    }
    ...
    public async Task<long> CreateBookingAsync(ResourceBooking booking)
    {
        ...
        return await conn.ExecuteScalarAsync<long>(@"
            ...
            SELECT last_insert_rowid();", booking);
    }
