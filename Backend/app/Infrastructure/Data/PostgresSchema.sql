...
-- ON DELETE CASCADE på user_id: en bokning ska tas bort om användaren raderas.
-- ON DELETE RESTRICT på room_id: en bokning ska inte försvinna om ett rum råkar raderas av misstag.
