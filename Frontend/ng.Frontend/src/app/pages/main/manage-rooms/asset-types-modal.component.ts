    ...
    <div class="asset-types-form">
      ...
      <div class="at-create-row">
        <input
          type="text"
          class="at-input"
          placeholder="Ny asset-typ, t.ex. Projektor..."
      ...
      <div class="at-list">
        @if (!currentAssetTypes().length) {
          <p class="at-empty">Inga asset-typer ännu.</p>
        }
          ...
          <div class="at-row">
            @if (editingId() === assetType.id) {
              ...
              <div class="at-actions">
                <app-button variant="primary" [disabled]="isSaving()" (clicked)="saveEdit(assetType.id)">
                  Spara
                </app-button>
              ...
              <div class="at-actions">
                <button type="button" class="btn-icon-sm" title="Redigera" (click)="startEdit(assetType)">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                  </svg>
                </button>
                <button type="button" class="btn-icon-sm danger" title="Ta bort" (click)="deleteAssetType(assetType)">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export class AssetTypesModalComponent {
  ...
  async deleteAssetType(assetType: AssetTypeResponseDto): Promise<void> {
    const confirmed = await this.confirmService.danger(
      `Vill du ta bort asset-typen "${assetType.description}"?`,
      'Ta bort asset-typ',
    );
    if (!confirmed) return;
